 ...
 */
class CucumberProjectTemplateProvider implements IProjectTemplateProvider {
...
<p>This is a parameterized hello world for Cucumber. You can set a parameter to modify the content in the generated file
...
final class HelloWorldProject {
	...
	override generateProjects(IProjectGenerator generator) {
		generator.generate(new ProjectFactory => [
			...
			addFile('''src/«path»/Model.feature''', '''
				/*
